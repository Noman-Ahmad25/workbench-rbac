  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-slate-500">Configure access levels and permissions.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <input 
          className="p-2 border border-slate-300 rounded focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition" 
          placeholder="Role Name (e.g. Content Editor)" 
          value={name} 
          onChange={e => setName(e.target.value)} 
        />
        <input 
          className="p-2 border border-slate-300 rounded focus:border-blue-500 focus:ring-1 outline-none transition" 
      ...
      <div className="flex justify-end gap-3 pt-4 border-t">
        <button onClick={onCancel} className="px-4 py-2 text-slate-600 hover:bg-slate-100 rounded-lg transition font-medium">Cancel</button>
        <button onClick={handleSubmit} className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm transition font-medium">
